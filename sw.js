/* KeySuite V4.23.07 Service Worker. */
const CACHE='keysuite-v42307';
const BOOTSTRAP='<script src="./v41200-bootstrap.js?v=42307"></script>';
const SHELL=[
...
function isSelectorPath(path){return /\/(?:selector|selector-g1|selector-bfi|selector-es)\//.test(path)}
