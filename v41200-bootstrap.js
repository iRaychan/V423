...
(()=>{
  ...
  window.KEYSUITE_VERSION='4.23.06';
  window.KEYSUITE_BUILD='V4.23.06';
  const VERSION='42306';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.23.06';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.23.06':'V4.23.06'});document.documentElement.setAttribute('data-keysuite-version','4.23.06')}catch(_){} }
  (async()=>{
    ...
    try{window.dispatchEvent(new CustomEvent('KEYSUITE_V41300_RUNTIME_READY',{detail:{version:'4.23.06'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_RUNTIME_READY',{detail:{version:'4.23.06'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_BRAND_RECOVERY'))}catch(_){ }
  })();
})();
